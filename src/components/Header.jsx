...
const Header = ( { toShow = true } ) => {
    ...
    return (
        ...
        <span className="neon-text">WE ARE OPEN, WELCOME TO OUR WEBSITE, ENJOY OUR DISCOUNTED PRICES</span>
    </div>
        </div>
        <header className="bg-white text-black p-4 px-8 flex items-center justify-between border-b">
        {/* Neon light */}
        
            <a href="/"><h1 className="text-2xl md:text-4xl font-semibold"><img src='https://res.cloudinary.com/dtszhuotx/image/upload/v1736449315/bg_r2hvja.png' alt='' style={{height: '80px', width: '80px'}}/> </h1></a>
